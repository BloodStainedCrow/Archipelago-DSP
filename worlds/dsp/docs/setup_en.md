...
This version of the Dyson Sphere Program Archipelago multiworld is in alpha.
If you encounter any bugs, or anything else noteworthy, please report it in the [DSP thread in the Archipelago Discord](https://discord.com/channels/731205301247803413/1209684747694121002).

## Requirements

- Dyson Sphere Program
- BepInEx
- The DSP Archipelago mod, `DSPArchipelago`
...
The [DSP Archipelago](https://thunderstore.io/c/dyson-sphere-program/p/BloodStainedCrow/DSPArchipelago/) mod is available on Thunderstore. To install the DSP Archipelago mod using a mod manager, follow these steps:
...
1. Search for `DSPArchipelago` in the mod manager's mod list
1. Install the `DSPArchipelago` mod (the dependencies will be installed automatically)
...
1. Download the latest release zip file of the `DSP_AP` mod from the [mod release page](https://github.com/BloodStainedCrow/DSP_AP/releases/)
...
- [BulletTime](https://thunderstore.io/c/dyson-sphere-program/p/starfi5h/BulletTime/), which is recommended for running syncs with Archipelago
